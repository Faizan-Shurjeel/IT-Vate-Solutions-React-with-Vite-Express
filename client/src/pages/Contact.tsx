      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-neutral-600">We'd love to hear from you. Fill out the form below and we'll get back to you as soon as possible.</p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-neutral-50 p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-neutral-600 mb-2">
                    <span className="font-medium">Email:</span> <a href="mailto:info@itvatesolutions.com" className="hover:text-primary transition-colors">info@itvatesolutions.com</a>
                  </p>
                  <p className="text-neutral-600">
