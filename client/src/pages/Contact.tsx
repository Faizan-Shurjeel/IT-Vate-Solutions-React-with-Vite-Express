          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-neutral-50 p-6 rounded-lg shadow-md md:col-span-2 flex flex-col items-center text-center">
                  ...
                  <div className="w-full max-w-md flex flex-col items-center">
                    ...
                    <p className="text-neutral-600 mb-4">
                      <span className="font-medium">Phone:</span> +92 303
                      8411166
                    </p>
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium px-4 py-2 rounded-md transition-colors shadow-md mt-2"
                    >
                      <svg
                        width="20"
                        height="20"
